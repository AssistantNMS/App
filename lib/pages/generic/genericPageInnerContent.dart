...
class GenericPageInnerContent extends StatelessWidget {
  final String itemId;
  final GenericPageItem itemDetails;
  final void Function(Widget) updateDetailView;

  GenericPageInnerContent(this.itemId,
      {Key key, this.itemDetails, this.updateDetailView})
      : super(key: key) {
  ...
  Widget getBody(BuildContext context, GenericPageViewModel vm,
    ...
    requiredItemDetailsFunction =
        (BuildContext context, RequiredItemDetails requiredItemDetails,
            ...
            requiredItemDetailsWithCraftingRecipeTilePresenter(
              ...
              onTap: updateDetailView != null
                  ? () => navigateWithinUpdateView(requiredItemDetails.id)
                  : null,
            );
    ...
    rechargeItemFunction = (BuildContext context, ChargeBy chargeBy,
        ...
        chargeByItemTilePresenter(
          context,
          chargeBy,
          genericItem?.chargedBy?.totalChargeAmount,
          showBackgroundColours: vm.displayGenericItemColour,
          onTap: updateDetailView != null
              ? () => navigateWithinUpdateView(chargeBy.id)
              : null,
        );
    ...
    usedToRechargeItemFunction = (BuildContext context, Recharge recharge,
        ...
        usedToRechargeByItemTilePresenter(
          ...
          showBackgroundColours: vm.displayGenericItemColour,
          onTap: updateDetailView != null
              ? () => navigateWithinUpdateView(recharge.id)
              : null,
        );
  ...
  void navigateWithinUpdateView(String appId) {
    updateDetailView(GenericPageInnerContent(
      appId,
