...
List<LocalizationMap> supportedLanguageMaps = [
    ...
    LocalizationMap(LocaleKey.czech, 'cs', 'cz', percentageComplete: 99),
    ...
    LocalizationMap(LocaleKey.vietnamese, 'vi-vn', 'vn', percentageComplete: 88),
    ...
    LocalizationMap(LocaleKey.ukrainian, 'uk', 'ua', percentageComplete: 29),
