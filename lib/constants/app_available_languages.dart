...
List<LocalizationMap> supportedLanguageMaps = [
    ...
    LocalizationMap(LocaleKey.dutch, 'nl', 'nl', percentageComplete: 72),
    ...
    LocalizationMap(LocaleKey.turkish, 'tr', 'tr', percentageComplete: 88),
    ...
    LocalizationMap(LocaleKey.ukrainian, 'uk', 'ua', percentageComplete: 28),
