...
List<LocalizationMap> supportedLanguageMaps = [
  ...
  LocalizationMap(LocaleKey.turkish, 'tr', 'tr', percentageComplete: 96),
  ...
  LocalizationMap(LocaleKey.vietnamese, 'vi-vn', 'vn', percentageComplete: 98),
  LocalizationMap(LocaleKey.urdu, 'ur', 'pk', percentageComplete: 7),
  LocalizationMap(LocaleKey.filipino, 'ph', 'ph', percentageComplete: 0),
  LocalizationMap(LocaleKey.indonesian, 'id', 'id', percentageComplete: 96),
  LocalizationMap(LocaleKey.malaysian, 'ms', 'my', percentageComplete: 96),
