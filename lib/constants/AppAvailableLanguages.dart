...
List<LocalizationMap> supportedLanguageMaps = [
    ...
    LocalizationMap(LocaleKey.polish, 'pl', 'pl', percentageComplete: 97),
    LocalizationMap(LocaleKey.brazilianPortuguese, 'pt-br', 'br', percentageComplete: 97),
    ...
    LocalizationMap(LocaleKey.turkish, 'tr', 'tr', percentageComplete: 90),
    LocalizationMap(LocaleKey.hungarian, 'hu', 'hu', percentageComplete: 96),
    LocalizationMap(LocaleKey.simplifiedChinese, 'zh-hans', 'cn', percentageComplete: 97),
    ...
    LocalizationMap(LocaleKey.vietnamese, 'vi-vn', 'vn', percentageComplete: 90),
    LocalizationMap(LocaleKey.urdu, 'ur', 'pk', percentageComplete: 7),
    LocalizationMap(LocaleKey.filipino, 'ph', 'ph', percentageComplete: 0),
    LocalizationMap(LocaleKey.indonesian, 'id', 'id', percentageComplete: 88),
    LocalizationMap(LocaleKey.malaysian, 'ms', 'my', percentageComplete: 88),
