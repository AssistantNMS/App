...
Map<String, Widget Function(BuildContext)> initNamedRoutes(
  ...
  routes.addAll({
    Routes.home: (context) => DefaultHomePage(),
    ...
    Routes.donation: (context) => Donation(),
    Routes.cart: (context) => CartPage(),
    Routes.exploits: (context) => ExploitsPage(),
    Routes.guides: (context) => GuidesPage(),
    Routes.portals: (context) => PortalsPage(),
    Routes.advancedSearch: (context) => AdvancedSearch(),
    ...
    Routes.cataloguePage: (context) => CataloguePage(),
    Routes.contributors: (context) => ContributorsPage(),
    Routes.helloGamesCommunityMission: (context) => CommunityMissionPage(),
    Routes.whatIsNew: (context) => EnhancedWhatIsNewPage(),
    ...
    Routes.newItems: (context) => NewItemsPage(),
    Routes.techTree: (context) => UnlockableTechTreePage(),
    Routes.inventoryList: (context) => InventoryListPage(),
    Routes.favourites: (context) => FavouritesPage(),
    Routes.syncPage: (context) => SyncPage(),
    Routes.timerPage: (context) => TimersPage(),
    Routes.valentinesPage: (context) => Valentines2021(),
    Routes.retiredDrawerMenuPage: (context) => RetiredDrawerMenuPage(),
    Routes.solarPanelBatteryCalculator: (context) => SolarPanelCalcPage(),
    Routes.friendCodeListPage: (context) => FriendCodeListPage(),
    Routes.onlineMeetup2020Page: (context) => OnlineMeetup2020Page(),
    ...
    Routes.helloGamesWeekendMission: (context) => WeekendMissionMenuPage(),
    Routes.helloGamesWeekendMissionMenu: (context) => WeekendMissionMenuPage(),
    Routes.communitySpotlight: (context) => CommunitySpotlightPage(),
    Routes.customHome: (context) => CustomHomepage(),
    Routes.allItemsPage: (context) => AllItemsPage(),
    ...
    Routes.nmsfmPage: (context) => NMSFMPage(),
