...
class GenericPageItem {
  ...
  Map<String, dynamic> toJson() => {
        ...
        'power': this.power,
        'cdnUrl': this.cdnUrl,
        'chargedBy': this.chargedBy,
        'additional': this.additional,
        'description': this.description,
        'maxStackSize': this.maxStackSize,
        'cookingValue': this.cookingValue,
        'currencyType': this.currencyType,
        'requiredItems': this.requiredItems,
        'baseValueUnits': this.baseValueUnits,
        'usedToRecharge': this.usedToRecharge,
        'blueprintSource': this.blueprintSource,
        'consumableRewardTexts': this.consumableRewards,
        'blueprintCost': this.blueprintCost,
        'blueprintCostType': this.blueprintCostType,
        'statBonuses': this.statBonuses,
        'proceduralStatBonuses': this.proceduralStatBonuses,
        'numStatsMax': this.numStatsMax,
        'numStatsMin': this.numStatsMin,
        'eggTraits': this.eggTraits,
